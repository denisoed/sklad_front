...
export default function () {
  ...
  const parent = document.querySelector('.draggable-parent');
  ...
  const height = parent.clientHeight -
    parseFloat(window.getComputedStyle(parent, null).getPropertyValue('padding-top')) -
  ...
  vueDragEvent(window.data.move, 'end', {
    top: window.data.move.style.top,
    left: window.data.move.style.left,
  });
