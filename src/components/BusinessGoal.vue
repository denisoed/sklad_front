      ...
      <PageTitle :title="skladName ? skladName : 'Склад'">
        <div>
          <q-card-section class="q-pt-none">
            Это главная страница склада, на ней вы можете посмотреть цель продаж на год, статистику заработка и количество проданных товаров, а также быстро перейти к основным разделам: товары, остатки, история операций, настройки, расходы и категории.
          </q-card-section>
        </div>
      </PageTitle>
