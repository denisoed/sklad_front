...
const actions = computed(() => [
  ...
  {
    label: $t(`history.actions.${HISTORY_DEFECT}`),
    value: HISTORY_DEFECT,
    color: HISTORY_ACTIONS_COLORS[HISTORY_DEFECT]
  },
  {
    label: $t(`history.actions.${HISTORY_RETURN}`),
    value: HISTORY_RETURN,
    color: HISTORY_ACTIONS_COLORS[HISTORY_RETURN]
  }
])
