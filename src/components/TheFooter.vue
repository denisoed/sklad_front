  ...
  <template v-if="isMenuOpen">
    ...
    <div class="floating-menu">
      <div 
        ...
        class="floating-btn"
        :style="{ 
          '--delay': `${(baseActions.length - 1 - index) * 0.03}s`,
          '--index': baseActions.length - 1 - index,
        }"
        :class="{ 'floating-btn--divider': action.divider }"
      >
...
import { MANAGE_SKLAD_DIALOG, MANAGE_CATEGORY_DIALOG, MANAGE_COST_DIALOG } from 'src/config/dialogs'
