export default ({
  ...
  voiceCreate: {
    ...
    hint: 'Произнесите ключ и значение. Например: «склад обувь, категория кроссовки, название Nike Air Force белые сорок первый»',
    sayKeys: 'Ключи: склад, категория, название',
  },
  fuzy: {
    warehouse: ['склад'],
    category: ['категория'],
